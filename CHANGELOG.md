...
* Gim projects file *gim/names* is expected to be named *gim/mirrors* now and stores full mirror URLs rather than just names. Mirroring a Git repository on different hosts is now possible.
